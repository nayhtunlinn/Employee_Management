...
<div id="wrapper">
	...
	<form:form modelAttribute="employeeForm" action="${pageContext.request.contextPath}/employee/insert" method="post">
	...
	<form:form action="${pageContext.request.contextPath}/employee/create?redo" method="post" modelAttribute="employeeForm">
	    <form:hidden path="empid" /> 
     	<form:hidden path="departmentId" /> 
     	<form:hidden path="name" /> 
     	<form:hidden path="joinDate" /> 
